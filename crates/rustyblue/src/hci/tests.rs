...
fn test_hci_event_parsing() {
    ...
    let data = [
        ...
        0x01, 0x02, 0x03, 0x04, 0x05, 0x06, // Peer_Address
        0x0A, 0x00,        // Conn_Interval
        0x00, 0x00,        // Conn_Latency
        0x80, 0x0C,        // Supervision_Timeout
...
fn test_le_advertising_report_parsing() {
    ...
    let data = [
        ...
        3,                      // Data_Length
        0x09, 0x54, 0x65,       // Data (Type: Complete Local Name, Value: "Te")
        0xC3,                   // RSSI (-61 dBm)
    ];
