//! Tests for the Security Manager Protocol implementation
...
mod tests {
    ...
    fn test_security_level_conversion() {
        ...
        let l2cap_none: crate::l2cap::types::SecurityLevel = smp_none.into();
        let l2cap_enc: crate::l2cap::types::SecurityLevel = smp_enc.into();
        let l2cap_auth: crate::l2cap::types::SecurityLevel = smp_auth.into();
        let l2cap_sc: crate::l2cap::types::SecurityLevel = smp_sc.into();

        assert_eq!(l2cap_none, crate::l2cap::types::SecurityLevel::None);
        assert_eq!(
            l2cap_enc,
        ...
        let l2cap_none = crate::l2cap::types::SecurityLevel::None;
        let l2cap_auth = crate::l2cap::types::SecurityLevel::Authentication;
        let l2cap_auth_enc = crate::l2cap::types::SecurityLevel::AuthenticationAndEncryption;
        let l2cap_sc = crate::l2cap::types::SecurityLevel::SecureConnectionsWithEncryption;
